...
public class LiveLeagueViewPresenter extends PresenterStub {
    ...
    public LiveLeagueViewPresenter(IMainView activitycallback, Context context) {
        this.activitycallback = activitycallback;
        this.context = context;
    }

    public interface IMainView {
        void getLeagueUsers(JSONObject jsonObject);
    }

    //Get User stats captain point -----------//
    public void getUsers(String LeagueId, String TournamentId,String matchID) {
        ...
        Call<JsonObject> call = retrofitAipService.getLiveLeagueUsers(Constants.str_HEADER,
            ...
            public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
                if (response.body() != null) {
                    try {
                        ...
                        activitycallback.getLeagueUsers(jsonObject);
