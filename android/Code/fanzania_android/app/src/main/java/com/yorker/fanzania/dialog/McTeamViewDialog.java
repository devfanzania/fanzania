...
public class McTeamViewDialog extends BottomSheetDialogFragment {

    private McTeamviewDialogBinding binding;
    ...
    @SuppressLint("ValidFragment")
    public McTeamViewDialog(Context context, int tournamentID, int userTeamId, int customerId, String userTeamName, int matchID, String matchType) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.mc_teamview_dialog, container, false);
    ...
    public void getPlayersWithPoints(int tournamentID, int userTeamID, int userID, String matchType) {
