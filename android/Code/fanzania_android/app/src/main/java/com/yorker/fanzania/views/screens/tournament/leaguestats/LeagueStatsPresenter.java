...
public class LeagueStatsPresenter extends PresenterStub {
    ...
    public LeagueStatsPresenter(IMainView activitycallback, Context context) {
    ...
    public interface IMainView {
        void getLeagueStatsResponse(JSONObject jsonObject);
    }


    //Get top ten players -----------//
    public void getLeagueTopPlayers(String LeagueId, String TournamentId) {
        ...
        Call<JsonObject> call = retrofitAipService.getLeagueStatsTopPlayers(Constants.str_HEADER,
            ...
            public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
                if (response.body() != null) {
                    try {
                        ...
                        activitycallback.getLeagueStatsResponse(jsonObject);
    ...
    public void getLeagueTopTeams(String LeagueId, String TournamentId) {
        ...
        Call<JsonObject> call = retrofitAipService.getLeagueStastTopTeams(Constants.str_HEADER,
                Constants.RETROFIT_HEADER_TYPE,
                Constants.RETROFIT_HEADER_TOKEN1,
                sharedPrefManager.getCustomer_Id(),
                map);
